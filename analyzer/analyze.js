...
fs.writeFileSync('./subtitles/files/rarities.json', JSON.stringify(word_rarities, null, 4));
...
tracks.forEach(track => {
    ...
    delete track_metadata.track_summary_rarity_point;

    const json_metadata_body = JSON.stringify(Object.assign({}, track_metadata, {
        complexity: Number((track_summary_rarity_point * 100).toFixed(3))
    }), null, 4);
